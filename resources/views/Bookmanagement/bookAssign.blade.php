...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb p-0" style='margin-top:0px'>
      <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
      <li class="breadcrumb-item"><a href="#">Library Management</a></li>
                    ...
                    <div class="card card-outline card-orange">
                        <div class="row m-2">
                                 <div class="col-md-12 text-center">
                                      <!-- Library selector would be here -->
                                </div>
                                </div> 
                            ...
                            <div class="row ">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="issue_date" id="issue_date" value="" required >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="admissionNo" class="text-danger">Admission No* </label>&nbsp;<a data-toggle="modal" data-target="#searchModal" style='cursor:pointer;vertical-align: text-top;font-size:9px;color:blue'>[ Search Student ]</a>
                                        <input type="text" class="form-control" name="admissionNo" id="admissionNo" required placeholder="Admission No" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="accession_no" class="text-danger">Accession No*</label>
                                        <input type="text" class="form-control" name="accession_no" id="accession_no" required placeholder="Accession No" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly class="form-control" id="student_name" placeholder="Student Name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="father_name">Father's Name</label>
                                                    <input type="text" readonly class="form-control" id="father_name" placeholder="Father's Name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="mobile_no">Mobile No</label>
                                                    <input type="text" readonly class="form-control" id="mobile_no" placeholder="Mobile No">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                        ...
                                        <div class="row p-4">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly class="form-control" id="library_name" placeholder="Library Name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="book_name">Book Name</label>
                                                    <input type="text" readonly class="form-control" id="book_name" placeholder="Book Name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="author_name">Author Name</label>
                                                    <input type="text" readonly class="form-control" id="author_name" placeholder="Author Name">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="book_category">Book Category</label>
                                                    <input type="text" readonly class="form-control" id="book_category" placeholder="Book Category">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="quantity">Quantity</label>
                                                    <input type="text" readonly class="form-control" id="quantity" placeholder="Quantity">
                                                </div>
                                            </div>
    ...
    $.ajax({
            ...
            if (!data['student']) {
                ...
                if (data['books'] && data['books'].length > 0) {
                    for (var i = 0; i < data['books'].length; i++) {
                        ...
                        var status = (book.status == 0 ? 'Not Returned' : 'Returned');
                        var text_color = status == 'Not Returned' ? 'text-danger' : 'text-success';
                        var code = '<tr><td><input type="checkbox" class="assigned_checkbox" value="'+book.id+'"/></td><td>' + book.book_name + '</td><td>' + book.book_code + '</td><td>' + book.issue_date + '</td><td>' + book.due_date + '</td><td><span class='+text_color+'>' + status + '</span></td></tr>';
                        if (book.status == 0) {
                    ...
                    if (assigned_book_array.includes(book_id)) {
                        ...
                        $('#note_text_main').html("Already Assigned this book for this student");
       ...
       $('#assign_book').submit(function(event){
            ...
            $.ajax({
                ...
                list.append('<tr class="selected_admission_no" data-admissionNo="'+item.admissionNo+'" style="cursor:pointer"><td>'+ item.admissionNo +'</td><td>' + (item.first_name ?? '')+' '+ (item.last_name ?? '') + '</td><td>' + item.mobile + '</td><td>' + item.email + '</td></tr>');
            });
...
if(array.length >0)
{
    $('#return_book').html('<button id="confirm_return" class="btn btn-success" >Confirm Return</button>')
}
else
{
     $('#return_book').html('')
