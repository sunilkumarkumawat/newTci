                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body ">
                                            <div id="subjectContainer"
                                                class="justify-content-center card-body d-flex flex-wrap gap-3">
                                                <span class='empty-message'>Please select a subject to see the
                                                    overview.</span>
                                            </div>

                                            <div class="d-flex flex-wrap gap-2 mb-2 justify-content-center align-items-end"
                                                id="questionMarkSection">
                                                <div class="mr-2">
                                                    <label for="per_question_marks" class="form-label">Per Question Marks
                                                        <span class="text-danger">*</span></label>

                                                    <input type="text" name="per_question_marks" id="per_question_marks"
                                                ...
                                                <div class="mr-2">
                                                    ...
                                                    <input type="text" name="total_marks" id="total_marks" value="0"
                                                        class="form-control" readonly />
                                                </div>
                                            </div>

                                            <div class="col-md-12 p-0 mt-4">
                                                {{-- <a href="{{ url('paperPreview') }}" class="btn btn-primary">Preview</a> --}}
                                                <button type='button'class="btn btn-primary" id="generatePreview" >Preview</button>
                                            </div>
                                            <div class="col-md-12 p-0 mt-4" id='loadPreview'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success d-none"
                        id="create_questions_topic_wise">Create</button>
