                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-credit-card"></i> &nbsp;Wallet</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-wrap gap-1">
                                                        <button class="btn btn-success btn-sm"><i class="bi bi-plus-lg"></i> Add</button>
                                                        <button class="btn btn-info btn-sm text-white"><i class="bi bi-eye"></i> Details</button>
                                                    </div>
                                                </td>  
                                            </tr>
                                            <tfoot>
