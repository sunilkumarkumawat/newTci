                                    ...
                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                        ...
                                        <div class="mt-3">
                                            <div class="btn-group" role="group">
                                                <a href="#" class="btn btn-sm btn-outline-primary">Use for Library
                                                    Fees</a>
                                                <a href="#" class="btn btn-sm btn-outline-success">Use for Extra
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <small class="text-muted">
                                    <ul class="mb-0 ps-3">
                                        <li>Wallet funds can be used for library fees, printing, fines, and other services.
                                        </li>
                                        <li><span class="text-warning">Extra Payment</span>: Any extra fee payments will be
                                            automatically credited to your wallet.</li>
                                        <li><span class="text-info">Advance Payment</span>: Advance payments will be shown
                                            in your wallet.</li>
                                    </ul>
                                </small>
                            </div>
