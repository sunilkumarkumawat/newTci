                        ...
                        <div class="card card-outline card-orange">
                            <div class="card-header bg-primary flex_items_toggel">
                                <div class="card-title">
                                    <h4><i class="fa fa-shirtsinbulk"></i> &nbsp;View Teachers</h4>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Ex. Name, Mobile, Email, Aadhaar etc." value="">
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img class="profileImg pointer" src="https://via.placeholder.com/50"
                                                    alt="Profile Image">
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs" data-toggle="dropdown"
                                                    title="Show Option"><i class="fa fa-bars"></i></a>
                                                <ul class="dropdown-menu">
                                                    <a href="#">
                                                        <li class="dropdown-item text-success"><i
                                                                class="fa fa-print text-success"></i> Joining Print</li>
                                                    </a>
                                                    <a href="#">
                                                        <li class="dropdown-item text-primary"><i
                                                                class="fa fa-edit text-primary"></i> Edit</li>
                                                    </a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#Modal_id"
                                                        class="deleteData">
                                                        <li class="dropdown-item text-danger"><i
                                                                class="fa fa-trash-o text-danger"></i> Delete</li>
                                                    </a>
                                                </ul>
                                            </td>
                                        </tr>
