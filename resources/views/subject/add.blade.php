                        ...
                        <div class="card card-outline card-orange">
                            <div class="card-header bg-primary">
                                <div class="card-title">
                                    <h4><i class="fa fa-user-circle-o"></i> &nbsp;Add Subject</h4>
                                </div>
                            </div>

                            <div class="card-body">
                                <form id="createCommon" data-modal="Subject">
                                    @if ($isEdit)
                                        <input type='hidden' value="{{ $data->id ?? '' }}" name='id' />
                                    @endif
                                    <input type='hidden' value='Subject' name='modal_type' />
                    ...
                    <div class="col-md-8 col-12">
                        <div class="card card-outline card-orange">
                            <div class="card-header bg-light">
                                <div class="card-title">
                                    <h4><i class="fa fa-user-circle"></i> &nbsp;View Subject</h4>
                                </div>
                            </div>
                            <div class="card-body">
