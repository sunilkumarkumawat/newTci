                ...
                <div class="row">
                    <div class="col-md-12 col-12 p-0">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('userAdd') }}">UserAdd</a></li>
                    ...
                    <div class="card card-outline card-orange col-md-12 col-12 p-0">
                        <div class="card-header bg-primary">
                            <div class="card-title">
                                <h4><i class="fa fa-desktop"></i> &nbsp;Edit User</h4>
                            </div>
                            <div class="card-tools">
                                ...
                                <a href="{{ url('userView') }}" class="btn btn-primary  btn-sm"><i
                                        class="fa fa-eye"></i> <span class="Display_none_mobile">
                                        {{ __('common.View') }} </span></a>
                            </div>
                        </div>
                        <!-- Profile Upload Section -->
                        <div class="row">
                            <div class="col-md-3 col-12 box">
                                <div class=" text-center py-4 regular ">
                                    <div class="d-grid">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="step-1" class="wizard-step">
                                            <span class="fw-bold"><i class="fa fa-user"></i> Basic Details</span>
                                            <div class="row">
                                                <div class="col-md-4">
