                        ...
                        <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name"
                                                                placeholder="Name" name="name" data-required="true"
                            ...
                            <input type="text" id="docCategory" class="form-control" placeholder="e.g., Aadhaar Card, Marksheet"> -->
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="file" id="docFiles" class="form-control"
                                                            multiple>
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        <button type="button" class="btn btn-primary" id="addDocBtn">Add
                                                            Document</button>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            @if ($isEdit)
                                                                <div class="col-md-6 mb-3">
                                                                    <div class="border rounded p-3 h-100">
                                                                        <h6 class="mb-3 text-success">Previous Saved
                                                                            Documents:</h6>
                                                                        <div id="showSavedDocuments" class="row g-2">

                                                                            @include(
                                                                                'common.savedDocuments',
                                                                                [
...
{{-- check data already exist or not --}}
    {{-- <script>
        function checkUserField(field) {
            let value = $('#' + field).val().trim();
            let errorBox = $('#' + field + '-error');
            let userId = '{{ $user->id ?? '' }}'; // use if you're editing a user

            if (!value) return;

            $.ajax({
                url: '{{ route('user.checkExist') }}',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    field: field,
                ...
                success: function(response) {
                    if (response.exists) {
                        errorBox.removeClass('d-none').text(response.message);
