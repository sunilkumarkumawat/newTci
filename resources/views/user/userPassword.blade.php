                    ...
                    <div class="card card-outline card-orange col-md-12 col-12 p-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-2 ">
                                <div class="row" id="excelExportBtnWrapper">
                                    <div class="col-md-12 text-right">
                                        <button style='display:none' id='exportBtn'
                                ...
                                <form id="generatePasswordForm" data-modal='User' method="post"
                                    action="{{ url('generatePassword') }}">
                                    <table id='generatePassTable'
                                        class="generatePassTable d-none table table-bordered table-striped">
                                        <thead>
                                            <tr class="bg-light">
                                                <th>SR.NO</th>
                                                <th>Name</th>
