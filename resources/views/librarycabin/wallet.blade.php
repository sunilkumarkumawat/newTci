                                            ...
                                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                                ...
                                                <div class="mt-3">
                                                    <div class="btn-group" role="group">
                                                        <a href="#" class="btn btn-sm btn-outline-primary">Use for
                                                            Library
                                                            Fees</a>
                                                        <a href="#" class="btn btn-sm btn-outline-success">Use for
                                                            Extra
                                                            Services like locker etc</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge bg-warning text-dark">Extra Payment</span>
                                                        </td>
                                                        <td>₹5,300</td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            <ul class="mb-0 ps-3">
                                                <li>Wallet funds can be used for library fees, printing, fines, and other
                                                    services.
                                                </li>
                                                <li><span class="text-warning">Extra Payment</span>: Any extra fee payments
                                                    will be
                                                    automatically credited to your wallet.</li>
                                                <li><span class="text-info">Advance Payment</span>: Advance payments will be
                                                    shown
                                                    in your wallet.</li>
                                            </ul>
                                        </small>
                                    ...
                                    <div class="col-md-6 text-end">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-dark ms-2"
                                            data-bs-toggle="modal" data-bs-target="#transactionHistoryModal">
                                            View Full History
                                        </button>
                                    </div>
                                </div>
