...
@section('content')
                        ...
                        <div class="card card-orange card-outline">
                            <div class="card-header bg-primary">
                                <div class="card-title">
                                    <h4><i class="fas fa-user-clock mr-2"></i>Membership Renewal Tracker</h4>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="dataEntry">
                                            ...
                                            <td data-label="Actions" class="action-column">
                                                <button class="btn btn-success btn-action"><i class="fas fa-sync-alt"></i>
                                                    Renew</button>
                                                <button class="btn btn-info btn-action"><i class="fas fa-envelope"></i>
                                                    Notify</button>
                                                <button class="btn btn-secondary btn-action"><i class="fas fa-user"></i>
                                                    Profile</button>
                                            </td>
                                        </tr>
    ...
    <style>
        ...
        .action-column {
            ...
            /* adminlte.min.css  ( .table td- vertical-align: top;)*/
        }
        ...
        @media (max-width: 767px) {
            ...
            .custom-responsive-table {
                width: 100%;
                min-width: 850px;
                /* Minimum width to ensure all columns display properly */
            }
        ...
        @media (min-width: 375px) and (max-width: 428px) {
            ...
            .card-body.table-responsive {
                margin: 0 -10px;
                /* Increase visible area slightly */
            }
        }
