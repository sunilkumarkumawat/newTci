                ...
                <div class="row">
                    <div class="card card-outline card-orange col-md-12 col-12 p-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="bg-item border p-3 rounded studentnameParameter d-none">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" id="default_password" class="form-control form-control-sm"
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button id="exportBtn" style="display: none"
                                            onclick="exportToExcelUsingSheetJS('generatePassTable')"
                                            class="btn btn-outline-primary"><i class="fa-solid fa-file-export"></i>
                                            Excel</button>
                                    </div>
                                </div>
                                <form id="generatePasswordForm" data-modal='Student' method="post"
                                    action="{{ url('generatePassword') }}">
                                    <table id='generatePassTable'
                                        class="table table-bordered table-striped d-none generatePassTable">
                                        <thead>
                                            <tr class="bg-light">
                                                <th>SR.NO</th>
                                                <th>Name</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan='100%' class='text-center'><button type='submit'
                                                        class='btn btn-sm bg-success'>Submit</button></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </form>
                    ...
                    $('#quickForm').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('.generatePassTable,.studentnameParameter').removeClass('d-none');
                        ...
                        switch (selectedValue) {
                            ...
                            case 'custom':
                                const fullName = row.find('td:nth-child(2)').text()
                                    .trim(); // assuming name is in 2nd column
