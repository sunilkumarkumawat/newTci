...
$permissions = Helper::getPermissions();
 ...
 $length = 6; // desired length of the unique ID
    $uniqueId = null;

    function generateRandomAlphanumericId($length = 6) {
    ...
    do {
        $uniqueId = generateRandomAlphanumericId($length);
    } while (
        DB::table('student')->where('unique_id', $uniqueId)->exists()
    );
@endphp
                ...
                <div class="card card-outline card-orange col-md-12 c0l-12 p-0">
                    <div class="card-header bg-primary">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ url('studentView') }}" class="btn btn-primary  btn-sm"><i
                                    class="fa fa-eye"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 py-2">
                            ...
                            <div class="card-body">
                                ...
                                <form id="createCommon" enctype="multipart/form-data" data-step="1"
                                    data-total_steps='3'>
                                       @csrf
                                    @if ($isEdit)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel" class="form-control"
                                                                    ...
                                                                    placeholder="Aadhaar No." data-required="false"
                                                                    onkeypress="javascript:return isNumber(event)"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" class="form-control"
                                                                    name="aadhaar_image" accept="image/*">
                                                                <!-- No value for file inputs for security reasons -->
                                                            </div>
                                                        </div>
                                                    </div>
